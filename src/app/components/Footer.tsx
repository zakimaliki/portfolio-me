                ...
                <div className="grid md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://linkedin.com/in/zaki-maliki-b6a798168" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-200 flex items-center">
                                {/* LinkedIn Icon */}
                            ...
                            <a href="https://github.com/zakimaliki" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-200 flex items-center">
                                {/* GitHub Icon */}
                                <svg className="w-6 h-6 mr-1" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            <li>malikzakitop@gmail.com</li>
                            <li>085311759600</li>
                            <li>Sleman, Yogyakarta, Indonesia</li>
                        </ul>
                    </div>
                </div>
